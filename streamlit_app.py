        ...
        try:
            if pdf_file is not None:
                with st.spinner('Running...'):
                    ...
                    ##################################################
                    # Summary
                    reworded_summary_section = util_v2.reword_section_text(summary_prompt, 'Summary', summary_section, "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", model) #st.secrets["api_key"], model)
                    ...
                    if util_v2.is_na_string(past_medical_section) == True and util_v2.is_na_string(familiy_history_section) == True:
                        ...
                        reworded_past_medical_family_history_section = util_v2.reword_section_text(past_medical_prompt, 'Past Medical/Family History', past_medical_family_history_combined, "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", model) #st.secrets["api_key"], model)
                    
                    # Surgical History
                    reworded_surgical_history_section = util_v2.reword_section_text(surgical_history_prompt, 'Surgical History', surgical_history_section, "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", model) #st.secrets["api_key"], model)
                    
                    # Current Medication
                    reworded_current_medication_section = util_v2.reword_section_text(current_medication_prompt, 'Current Medication', current_medications_section, "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", model) #st.secrets["api_key"], model)
                    
                    # Allergies
                    reworded_allergies_section = util_v2.reword_section_text(allergies_prompt, 'Allergies', allergies_section, "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", model) #st.secrets["api_key"], model)
                    
                    # Social History
                    reworded_social_history_section = util_v2.reword_section_text(social_history_prompt, 'Social History', social_history_section, "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", model) #st.secrets["api_key"], model)
                    
                    # Functional History
                    reworded_functional_history_section = util_v2.reword_section_text(functional_history, 'Functional History', functional_history_section, "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", model) #st.secrets["api_key"], model)
