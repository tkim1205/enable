...
def clean_section_text(api_key, model, section_text):
    ...
    """
    chatgpt_prompt = "I am a medical assistant. Try to spell-check the text below. If you are unsure, leave the text as is. If you cannot provide a response based on incomplete information, leave text as is.\n\nText below:\n\n" + section_text
