...
def clean_section_text(api_key, model, section_text):
    ...
    """
    chatgpt_prompt = "I am a medical assistant. Try to spell-check the text below. If you are unsure, leave the text as is. If the text is talking about an attached page, ignore.\n\nText below:\n\n" + section_text
