...
def clean_section_text(api_key, model, section_text):
    ...
    """
    chatgpt_prompt = "I am a medical assistant. My purpose is to look at the string of text below, and if it only references an external document like an attached page, then return N/A. Otherwise return the text without any modification:\n\n" + section_text
