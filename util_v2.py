...
def clean_section_text(api_key, model, section_text):
    ...
    """
    chatgpt_prompt = "If the text below only references an external document, like an attached page, then remove the reference to the external document in the text. Otherwise leave the text as is:\n\n" + section_text
